...
class PageRoutes {
  static final pages = [
    ...
    GetPage(name: CollectionRoute.profile, page: () => const ProfilePage()),
    GetPage(name: CollectionRoute.myfaq, page: () => const MyFAQPage()),
    GetPage(name: CollectionRoute.faq, page: () => const FAQPage()),
    GetPage(name: CollectionRoute.about, page: () => const AboutPage()),
    GetPage(name: CollectionRoute.role, page: () => const RolePage()),
    GetPage(name: CollectionRoute.help, page: () => const HelpPage()),
    GetPage(name: CollectionRoute.setting, page: () => const SettingPage()),
    GetPage(name: CollectionRoute.addpost, page: () => const AddPost()),
    GetPage(name: CollectionRoute.homepage, page: () => const HomePage()),
    GetPage(name: CollectionRoute.calendar, page: () => const CalendarPage()),
    GetPage(name: CollectionRoute.schedule, page: () => const SchedulePage()),
    GetPage(name: CollectionRoute.bar, page: () => const BottomBar()),
  ];
}
