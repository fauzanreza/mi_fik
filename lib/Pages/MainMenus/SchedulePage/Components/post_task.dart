                    ...
                    onPressed: () async {
                      if (isLoadPost == false) {
                        ...
                        if (dateStartCtrl == null || dateEndCtrl == null) {
                          isValid = false;
                          taskPeriodMsg = "date period must be selected".tr;
                          Get.dialog(FailedDialog(
                              text: taskPeriodMsg, type: "addtask"));
                        } else {
                          if (dateStartCtrl.isAfter(dateEndCtrl)) {
                            isValid = false;
                            taskPeriodMsg = invalidDateMsg;
                            Get.dialog(FailedDialog(
                                text: invalidDateMsg, type: "addtask"));
                          }
                        }
                        ...
                        if (isValid) {
                          if (DateTime.now().isAfter(dateStartCtrl)) {
                            isValidNow = false;
                            taskPeriodMsg = invalidDateToNowMsg;
                            Get.dialog(FailedDialog(
                                text: invalidDateToNowMsg, type: "addtask"));
                          }
